...
function Rate = SDMA_Rate(H_est,Hall,SNRdB,weight,tolerance,M,c,d,Nt,N_user,Rth)
SNR = 10^(SNRdB/10);
%N_user * Nt
...
while true
    ...
    [WMMSE,p_p] = SDMA_CVX_Optimization(SNR,weight,Nt,N_user,u_opt_p_aveg,e_p_aveg,f_p_aveg,v_p_aveg,w_p_aveg,Rth);
