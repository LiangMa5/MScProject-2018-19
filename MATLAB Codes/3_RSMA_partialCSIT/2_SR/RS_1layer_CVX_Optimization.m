...
function [WMMSE,p_p,p_c] = RS_1layer_CVX_Optimization(SNR,weight,Nt,N_user,u_opt_c_aveg,u_opt_p_aveg,e_c_aveg,e_p_aveg,f_c_aveg,f_p_aveg,v_c_aveg,v_p_aveg,w_c_aveg,w_p_aveg,Rth)
u1 = weight(1);
