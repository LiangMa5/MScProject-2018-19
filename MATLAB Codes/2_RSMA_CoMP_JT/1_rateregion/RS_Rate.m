...
function [Rate_order1,Rate_order2] = RS_Rate(H,SNRdB,weight,tolerance)

% Order 1: The common rate is allocated to user-1 only
Rate_order1 = RS_Rate_oneorder(H,SNRdB,weight,tolerance);
...
Rate2 = RS_Rate_oneorder(H2,SNRdB,weight2,tolerance);
