...
function [WMMSE,p_1,p_2,p_c]=RS_CVX_Optimization(weight,H,SNR,g_c1,g_c2,g_p1,g_p2,u_opt_c1,u_opt_c2,u_opt_p1,u_opt_p2)
u1 = weight(1);
u2 = weight(2);
...
c_1 = u_opt_c1*MSE_c1-log2(u_opt_c1); %Capcity1 
c_2 = u_opt_c2*MSE_c2-log2(u_opt_c2); %Capcity2
c = max(c_1,c_2);
...
%% constraints
subject to
square_abs(p_1(1))+square_abs(p_2(1))+square_abs(p_c(1))-SNR/N_user <= 0;
square_abs(p_1(2))+square_abs(p_2(2))+square_abs(p_c(2))-SNR/N_user <= 0;
